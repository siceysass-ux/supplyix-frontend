...
export type IconName = 'zap' | 'shield' | 'cloud' | 'code' | 'globe' | 'settings' | 'lock' | 'chevron-down';
...
const icons: Record<IconName, React.ReactElement> = {
  ...
  globe: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h8a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.707 4.293l.586-.586a2 2 0 012.828 0l2.172 2.172a2 2 0 010 2.828l-5.172 5.172a2 2 0 01-2.828 0L2 11.586a2 2 0 010-2.828l.586-.586a2 2 0 012.828 0z" />,
