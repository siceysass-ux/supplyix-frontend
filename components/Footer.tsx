      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-4 md:mb-0">
            <p className="text-dark-blue">&copy; {new Date().getFullYear()} Supplyix Inc. Tüm hakları saklıdır.</p>
          </div>
          <div className="flex space-x-6">
            <a href="https://www.instagram.com/supplyixturkiye/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary transition-colors" aria-label="Instagram">
            ...
            <a href="https://www.youtube.com/@Supplyix" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary transition-colors" aria-label="YouTube">
